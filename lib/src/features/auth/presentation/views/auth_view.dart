...
import '../../../../../features/auth/login/presentation/widget/custom_text_field.dart';
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  ref.read(loginProvider.notifier).doLoginApiCall(emailController.text, passwordController.text);
                },
                child: Container(
